      ...
      >
        ...
        >
          ...
          <g filter="url(#filter2_dddi_51_65)" data-figma-bg-blur-radius="22.0545">
            <path d="M123.116 79.1145L171.548 42.8776L97.2715 12.5164C94.8305 11.5186 93.61 11.0197 92.3446 11.1143C91.0793 11.2089 89.9465 11.8837 87.681 13.2334L56.155 32.0149C48.1832 36.7641 44.1973 39.1386 44.4205 42.4378C44.6438 45.737 48.9132 47.553 57.4522 51.1849L123.116 79.1145Z" fill="#E55B81" fillOpacity="0.30" shapeRendering="crispEdges" />
          </g>
          ...
          <g filter="url(#filter4_dddi_51_65)" data-figma-bg-blur-radius="22.0545">
            <path d="M171.548 78.9088V42.8774L123.116 79.1144L171.548 78.9088Z" fill="#C94870" fillOpacity="0.22" shapeRendering="crispEdges" />
          </g>
          <g filter="url(#filter5_dddi_51_65)" data-figma-bg-blur-radius="22.0545">
            <path d="M487.973 78.9088V42.8774L536.404 79.1144L487.973 78.9088Z" fill="#C94870" fillOpacity="0.22" shapeRendering="crispEdges" />
          </g>
          <defs>
            ...
            <linearGradient id="paint0_linear_51_65" x1="329.353" y1="42.8774" x2="329.353" y2="79.1144" gradientUnits="userSpaceOnUse">
              <stop stopColor="#F2A0B8" stopOpacity="0.7" />
              <stop offset="1" stopColor="#E55B81" stopOpacity="0.45" />
            </linearGradient>
          </defs>
        </svg>

        {/* Animated chip in the bucket opening */}
              ...
              {items.map((chip, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-white border border-zinc-200/60 z-10 rounded-full p-2 w-[240px] shadow-sm absolute pointer-events-auto flex items-center gap-2 origin-bottom"
                  >
                    <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-pink-50 text-pink-500">
        ...
        >
          <div
            ...
            style={{
              borderRadius: "22%",
              border: "2px solid rgba(229, 91, 129, 0.22)",
              boxShadow: "0 4px 18px rgba(229, 91, 129, 0.18)",
            }}
          >
            <Image
              src="/petallogo.png"
